module.exports = function ({ addComponents, theme }) {
  const modals = {
    ...
    ".msc-modal": {
      "@apply h-fit w-fit md:min-w-fit md:max-w-[90%] md:max-h-[90%] bg-white rounded-lg shadow-xl overflow-hidden flex flex-col place-content-stretch 2xl:h-fit 2xl:max-w-fit":
        {},
    },
    ".msc-modal-header": {
