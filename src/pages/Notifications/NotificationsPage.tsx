...
const NotificationsPage = () => {
	...
	return (
		<div className=" flex flex-row -mx-8 md:-mx-15 xl:-mx-20 w-full self-center" style={{ width: `${messageWidth}px` }}>
			<div className="flex flex-col min-w-fit h-full bg-slate-50" style={{ height: `${inboxHeight}px` }}>
			...
			{selectedNotification === null ? (
				<div className="flex w-full h-full bg-transparent" style={{ height: `${inboxHeight}px` }}>
					<div className="flex flex-col w-full h-full overflow-y-scroll">
						<p className="text-center my-auto text-2xl text-stone-400">Select a message to view details</p>
					</div>
				</div>
			) : (
				<div className="flex h-full w-full overflow-y-scroll mt-14 p-4">
					<div className="flex flex-col w-full h-full">
						<div className="flex flex-row w-full place-content-between p-4 overflow-hidden">
							<div className="flex flex-row gap-2 items-center overflow-hidden w-full">
								...
								>
									<p className="text-xl font-semibold my-auto">{selectedNotification?.name.charAt(0)}</p>
								</div>
								<div>
