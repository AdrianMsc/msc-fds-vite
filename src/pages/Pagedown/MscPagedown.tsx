					...
					<main className="flex overflow-auto">
						<div className="msc-pd-container">
							<div className="msc-pd-text-container">
								<h1 className="text-primary-blue_dark">We're upgrading our systems to serve you better</h1>
								<h4 className="text-primary-blue_dark">Thanks you for your patience!</h4>
							</div>
