...
import { buttonIcon, buttonLoadingState, buttonTextIcon, defaultButtons, disabledButtons } from './constants';

const MscButtonsPage = () => {
	return (
		<ComponentLayout>
			<MscComponentSnippet title="Default Buttons" code={defaultButtons} className="mb-4">
			...
			<MscComponentSnippet title="Disabled Buttons" code={disabledButtons} className="mb-4">
				<div className="msc-component-container-row">
					...
					<MscButton label="Small button" variant="solid" size="small" disabled />
				</div>
			</MscComponentSnippet>

			<MscComponentSnippet title="Button with icon" code={buttonTextIcon} className="mb-4">
				<div className="msc-component-container-row">
			...
			<MscComponentSnippet title="Button loading state" code={buttonLoadingState} className="mb-4">
				<div className="msc-component-container-row">
			...
			<MscComponentSnippet title="Icon button" code={buttonIcon} className="mb-4">
