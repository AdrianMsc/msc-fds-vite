...
const img = (name: string) =>
  imageModules[`../../assets/homepage/${name}`]?.default || '';
...
const MscLabHomepagePage = () => {
  ...
  useEffect(() => {
    ...
    scrollContainers.forEach((scrollContainer) => {
      ...
      const btnLeft = parent.querySelector<HTMLButtonElement>(
        'button.scroll-left',
      );
      const btnRight = parent.querySelector<HTMLButtonElement>(
        'button.scroll-right',
      );
  ...
  return (
    <ComponentLayout name="Lab Homepage" description="Homepage lab prototype">
      ...
      <div className="bg-[#F1F5FE] py-2 px-5 lg:px-10 2xl:px-0 text-center border border-primary-blue_light">
        <p>
          Free Ground Shipping on orders over <strong>$99</strong> - Online Only
          Enter Code <strong>MW99</strong>
          ...
          <div className="border border-primary-blue_light rounded w-full py-3 gap-3 h-fit flex flex-col">
            <div className="flex flex-row justify-between px-4">
              ...
              <div className="flex-row gap-2 hidden md:flex">
                <button className="scroll-left flex items-center justify-center rounded-full bg-transparent size-10 shadow-md" type="button">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 320 512"
                ...
                <button className="scroll-right flex items-center justify-center rounded-full bg-white size-10 shadow-md" type="button">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 320 512"
        ...
        <div className="flex gap-4 w-full">
          <picture>
            <source
              ...
              srcSet={img('slider-ss-test-a.jpg')}
            />
            <img
          ...
          <picture>
            <source
              media="(min-width:768px)"
              srcSet={img('slider-ss-test-b.jpg')}
            />
            <img
                ...
                >
                  ...
                  <div className="flex flex-row overflow-hidden gap-3 w-full h-fit items-center pt-3 align-bottom">
                    <div className="relative flex flex-col h-fit w-fit items-center self-end">
                      <p className="absolute bottom-8 bg-white w-fit z-10 text-xs">
                        Qty
                      </p>
                      <input
                        type="text"
      ...
      <section className="bg-white py-6">
        <div className="mx-auto max-w-screen-2xl px-5 lg:px-10 2xl:px-0 flex flex-col">
          <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center after:flex-1 after:bg-monochromes-grey_xlight after:h-[1px] sm:after:order-2 after:hidden sm:after:block">
            <h1 className="font-bold text-xl mr-2 order-1 sm:order-1">
              Browse Our Categories
            </h1>
          ...
          <div className="w-full lg:w-1/2 lg:min-h-96 flex lg:pl-[1.2rem] mb-8 lg:mb-0">
            <div className="relative bg-primary-blue_xdark text-white p-8 pr-[100px] rounded-3xl w-full max-w-[80%] sm:max-w-[358px] min-h-[395px]">
              ...
              <p className="text-sm lg:text-lg font-semibold mb-4">
                ...
                and has driven standardization here. I&apos;m looking forward to
      ...
      <section className="mx-auto max-w-screen-2xl flex flex-col px-5 lg:px-10 2xl:px-0">
          ...
          <article className="w-full md:w-6/12 bg-white rounded flex flex-col sm:flex-row">
            <div className="order-2 sm:order-1 p-5 sm:w-6/12 flex flex-col justify-center">
              ...
              <p className="text-sm mb-4">
                This body copy area can support up to 108 cc max including
                spaces and the text can wrap to container.
              </p>
              <button
        ...
        <article className="bg-white rounded p-6 mb-6">
          ...
          <p className="text-sm mb-4 text-monochromes-grey">
            ...
            inventory management and other supply chain solutions ensure that
            your workforce and facility are supplied with equipment that is
            reliable, durable and accurate for every operation.
          </p>
      ...
      <div id="icon-bigbook" className="hidden lg:inline-block">
        <img
          src="//cdn.mscdirect.com/global/v2/img/side-icons/bigbook-button.svg?v=3"
          alt="view the big book"
        />
      </div>

      <div id="icon-contact-us" className="hidden lg:inline-block">
