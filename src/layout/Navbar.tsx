...
const Navbar: React.FC = () => {
	...
	return (
		<header className="bg-white shadow py-4 px-5 flex flex-row w-full place-content-between items-center z-40 sticky top-0">
			...
			<div className={`fixed z-50 flex-col p-4 rounded-lg shadow-xl right-4 top-14 bg-white ${triggerModal}`}>
				<div className="border-b-[1px] border-monochromes-grey_xlight font-semibold pb-1">{user?.name}</div>
